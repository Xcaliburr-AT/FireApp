...
from fireapp.models import Locations, Incident, FireStation, Firefighters, FireTruck, WeatherConditions
    ...
    def create_incidents(self, count):
        ...
        for _ in range(count):
            Incident.objects.create(
                ...
                date_time=timezone.make_aware(fake.date_time_this_year()),
